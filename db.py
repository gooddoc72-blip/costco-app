...
from db_orders import (
    ...
    get_excluded_order_nos,
    get_excluded_orders,
    add_excluded_orders,
    remove_excluded_orders,
...
from db_shopping import (
    ...
    get_shopping_exclusion_rows,
    add_shopping_exclusions,
    remove_shopping_exclusions,
...
from db_inventory import (
    ...
    receive_deal_lots, add_lot, add_lot_units, adjust_stock, find_lots_by_memo,
    get_inventory_lots, get_stock_summary,
