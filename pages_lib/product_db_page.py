...
def _map_naver_category(whole_cat_name: str) -> str:
...
def _guess_category_from_name(product_name: str) -> str:
        ...
        if _ni_prods:
            ...
            if _save_clicked:
                ...
                for _nip in _ni_selected_pre:
                    ...
                    _ncat = _map_naver_category(_nip.get('wholeCategoryName', ''))
                    if _pname:
            ...
            if st.button("🏷 상품명으로 카테고리 자동 분류", key="bulk_cat_btn", type="primary"):
                ...
                for _bp in _no_cat_naver:
                    ...
                    if not _pid:
                        _skip += 1
                        continue
                    _guessed = _guess_category_from_name(_bp.get('costco_name', ''))
                    if _guessed:
